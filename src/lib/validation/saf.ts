...
export const SafVerificationStatusEnum = z.enum(['verified', 'pending', 'under_review']);

export const SafCertificateStatusEnum = z.enum(['active', 'retired', 'expired', 'cancelled']);

export const SafChainOfCustodyTypeEnum = z.enum(['mass_balance', 'segregation', 'book_and_claim']);
